...
b.position.x=a.center.x;b.position.y=a.center.y;b.width=a.radius?2*a.radius:a.width;b.height=a.radius?2*a.radius:a.height;b.rotation=a.angle};this.updatePolygon=function(a){var b=h[a.bodyID];b.clear();b.lineStyle(1/d,a.lineColor||260348);b.lineColor;b.drawPolygon(a.verticesToPath());for(var c=0;c<a.vertices.length-1;c++)b=a.vertices[c].midpoint(a.vertices[c+1]),g.drawLine(b,b.add(a.faceNormals[c].scale(10/d)));b=a.vertices[0].midpoint(a.vertices[a.vertices.length-1]);g.drawLine(b,b.add(a.faceNormals[a.faceNormals.length-
...
Polygon.prototype.updateInertia=function(){if(0===this.invMass)this.inertia=0;else{for(var a=0,b=0;b<this.vertices-1;b++)a+=this.vertices[b].x*this.vertices[b+1].y-this.vertices[b].y*this.vertices[b+1].x;a+=this.vertices[this.vertices.length-1].x*this.vertices[0].y-this.vertices[this.vertices.length-1].y*this.vertices[0].x;a=Math.abs(a);this.inertia=1/this.invMass*(a/2)/12;this.inertia=1/this.inertia}};
...
Circle.prototype.collidedCircCirc=function(a,b,c){var d=b.center.subtract(a.center),e=a.radius+b.radius,f=d.length();if(f>Math.sqrt(e*e))return!1;0!==f?(a=d.scale(-1).normalize().scale(b.radius),c.setInfo(e-f,d.normalize(),b.center.add(a))):a.radius>b.radius?c.setInfo(e,new Vec2(0,-1),a.center.add(Vec2(0,a.radius))):c.setInfo(e,new Vec2(0,-1),b.center.add(Vec2(0,b.radius)));return!0};function polygonConfiguration(){this.min;this.max;this.minIndex;this.maxIndex;this.normal;this.collisionType=[]}
Polygon.prototype.collisionTest=function(a,b){var c=!1;"Polygon"===a.type&&(c=this.collidedPolyPoly(a,b));return c};
Polygon.prototype.collidedPolyPoly=function(a,b){for(var c=new polygonConfiguration,d=new polygonConfiguration,e,f=0;f<this.faceNormals.length;f++)if(e=this.faceNormals[f],this.computeInterval(this,e,c),this.computeInterval(a,e,d),d.max<c.min||c.max<d.min)return this.lineColor=null,!1;for(f=0;f<a.faceNormals.length;f++)if(e=a.faceNormals[f],this.computeInterval(this,e,c),this.computeInterval(a,e,d),d.max<c.min||c.max<d.min)return this.lineColor=null,!1;this.lineColor="0xfc030f";b.setInfo(c.max,c.normal,
this.vertices[c.maxIndex]);b.changeDir();return!0};Polygon.prototype.collidedPolyRect=function(){};Polygon.prototype.collidedPolyCirc=function(){};Polygon.prototype.computeInterval=function(a,b,c){var d=999999,e=-99999,f={min:0,max:0};b.dot(a.vertices[0]);for(var g=0;g<a.vertices.length;g++){var h=b.dot(a.vertices[g]);h<d&&(d=f.min=h,c.min=h,c.minIndex=g,c.normal=b);h>e&&(e=f.max=h,c.max=h,c.maxIndex=g,c.normal=b)}return f};
