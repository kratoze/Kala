...
function Physics(){return{collision:function(a){var b,c,d,f=new CollisionInfo;for(d=0;40>d;d++)for(b=0;b<a.allBodies.length;b++)for(c=b+1;c<a.allBodies.length;c++)if(a.allBodies[b].broadphaseTest(a.allBodies[c])&&a.allBodies[b].collisionTest(a.allBodies[c],f)){0>f.getNormal().dot(a.allBodies[c].center.subtract(a.allBodies[b].center))&&f.changeDir();if(!0===a.allBodies[b].isSensor||!0===a.allBodies[c].isSensor)return f.bodyA=a.allBodies[b],f.bodyAIndex=b,f.bodyB=a.allBodies[c],f.bodyBIndex=c,f;var e=
